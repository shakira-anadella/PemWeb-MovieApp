...
<div class="page-wrapper">
    <!-- Page header -->
    <div class="card">
        <h2 class="page-title text-center mb-4">Tambah Film</h2>
        <div class="card-body">
            <form method="POST" action="{{ route('movie.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="synopsis" name="synopsis" rows="4" placeholder="Masukkan Sinopsis Film" required></textarea>
                </div>
                <!-- Movie Year -->
                <div class="mb-3">
                    <label for="year" class="form-label">Tahun</label>
                    <input type="number" class="form-control" id="year" name="year" placeholder="Masukkan Tahun Rilis" required>
                </div>
                <!-- Movie Genre -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Tekan <kbd>Ctrl</kbd> (Windows)</small>
                </div>
